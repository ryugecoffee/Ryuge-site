...
shipping: "送料について",
    ...
    modalButtonSub: "安全な決済",
        orioriLabel: "折々",
    orioriLead: "折々は、季節や日々の移ろいに合わせて、その時々の気配を届けるためのシリーズ。閻魔のように一つの軸を定めるのではなく、木函のように上位を収めるのでもなく、その間にある時間や感覚に寄り添いながら、その都度ふさわしいコーヒーやかたちを選び出していく。内容は固定されず、季節のコーヒー、定期便、珈琲袋などへと移ろいながら、日常の中で龍華珈琲に触れるための入口として、静かにひらかれていく。",
orioriDescription: "折々は、季節や日々の移ろいに合わせて、その時々の珈琲やかたちを届ける仕立て。",

    orioriSubscriptionTitle: "定期便",
    orioriSubscriptionText:
      "月ごとに移ろう焙煎や豆の表情を、折々の流れにあわせて届けます。",

    orioriDripbagTitle: "珈琲袋",
    orioriDripbagText:
